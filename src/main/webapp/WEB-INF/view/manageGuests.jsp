...
<body style="background-color: #e2e4c0;">
	<div class="text-center">
		...
		<br>
		<small class="text-muted">Manage Guests</small>
	</div>
						...
						<tbody>
							<c:forEach var="guest" items="${guests}">
								<tr>
									...
									<td><a href="update-guest?id=${guest.guestId}"><span
											class="glyphicon glyphicon-pencil"></span></a></td>
									<td><a href="delete-guest?id=${guest.guestId}"><span
				...
				<div class="bottom-section">
					<form method="POST" action="save-guest">
						...
						<div class="form-group row">
							<label for="guestName" class="col-sm-2 col-form-label">Guest
								Name:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control"
									value="${guest.guestName}" name="guestName"
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control"
									value="${guest.guestEmail}" name="guestEmail"
									placeholder="Email">
							</div>
						</div>
